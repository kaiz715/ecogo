          ...
          (Background.prototype.toString = function t(e) {
            ...
            var i = e.includes("size") && this.size ? " / " + this.size : "",
              list = [
                ...
                e.includes("position") ? this.position + i : "",
                  ...
                  var i = function t(i) {
                    ...
                    n = function t(i) {
                      if (
                        ...
                        i.originalEvent.touches.length > 1
                      )
                        e.touchDeltaX = 0;
                      else
                        e.touchDeltaX =
                          i.originalEvent.touches[0].clientX - e.touchStartX;
                    },
                    o = function t(i) {
                      if (
                        e._pointerEvent &&
        ...
        if (
          ...
          (data.map.mapTypeId =
            "satellite" === data.typeId
              ? t.maps.MapTypeId.HYBRID
              : t.maps.MapTypeId.ROADMAP),
          data.markers.length)
        )
        ...
        var u = function () {
          ...
          Wt = {
            ...
            destroy: function () {
              ...
              if ((t.setAttribute("aria-hidden", "true"), (t.className = K), E))
                clearInterval(E);
            ...
            updateSize: function (e) {
              ...
              if (
                ...
                (w.x = _e.center.x), (w.y = _e.center.y), mt(true);
              ct("resize");
            },
            ...
            if (o && t.currItem) {
              if ((i.updateIndexIndicator(), _.captionEl))
                _.addCaptionHTMLFn(t.currItem, l),
                  E(l, "caption--empty", !t.currItem.title);
              n = true;
            } else n = false;
            if (!h) O();
            I();
        ...
        var tt = function () {
              ...
              switch (e.type) {
                ...
                case v:
                  ...
                  var A = l.abs(k / Rt),
                    ...
                    I = At.getScrollTop() - E,
                    L = 0;
                  if (I > Mt) (L = (Mt - I) / E), (I = Mt);
                  else if (I < 0) (L = -I / E), (I = 0);
                  (A *= 1 - L),
                    At.animateTo((I + 0.5) | 0, {
                      easing: "outCubic",
                      duration: A,
                    });
                  break;
                ...
                if (u >= f[A].frame && u <= f[A + 1].frame) {
                  ...
                  for (T in E.props)
                    if (s.call(E.props, T)) {
                      ...
                      if (
                        ((L = E.props[T].easing(L)),
                        (S = ft(E.props[T].value, I.props[T].value, L)),
                        (S = ct(S)),
                        0 === T.indexOf("@"))
                      )
                        l.setAttribute(T.substr(1), S);
                  ...
                  if (_)
                    if (C !== A) {
                      if ("down" === Nt) gt(l, E.eventType, Nt);
          ...
          dt = function (t, e) {
            ...
            for (var i, n, o = 0, a = t.length; o < a; o++)
              if (((n = t[o]), (i = Lt[n[F]]), i))
                if (e)
                  (n.style.cssText = i.dirtyStyleAttr), _t(n, i.dirtyClassAttr);
                else
        ...
        loader = (function () {
              ...
              if ((g = a.loadMode) && X < 8 && (e = x.length)) {
                for (n = 0, $++; n < e; n++)
                  if (x[n] && !x[n]._lazyRace)
                    if (
                      !(!V || (o.prematureUnveil && o.prematureUnveil(x[n])))
                    ) {
          ...
          return {
            _: function () {
              ...
              if (o.elements.length) J(), E._lsFlush();
              else tt();
            },
            checkElems: tt,
            unveil: ut,
